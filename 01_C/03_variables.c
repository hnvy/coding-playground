...
int main()
{
	...
	int digit, digital, total; // ~int~ is a special keyword which C reads. It stands for "integer". You can replace the words which follow with whatever you like.
	...
	*/
	...
	total = digit1 * decimal; // Multiply the two digits.
